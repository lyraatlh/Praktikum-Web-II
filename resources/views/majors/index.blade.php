<x-default-layout title="Majors" section_title="List of Majors">
    <div class="flex mb-4">
            ...
            <tbody class="text-zinc-700 text-sm font-light">
                @foreach ($majors as $major)
                    <tr class="border-b border-zinc-200 hover:bg-zinc-100">
                        ...
                        <td class="py-3 px-6">{{ $major->name }}</td>
                        <!-- <td class="py-3 px-6 text-center">{{ $major->student_id_number ?? 0}}</td> -->
                        <td class="py-3 px-6 flex justify-center gap-1">
                            <a href="{{ route('majors.show', $major->id) }}" class="bg-blue-50 border border-blue-500 p-2">
                                <i class="ph ph-eye text-blue-500"></i>
                            </a>
                            <a href="{{ route('majors.edit', $major->id) }}" class="bg-yellow-50 border border-yellow-500 p-2">
